...
public class NCVKPSPublicSoap
{
    ...
    public NCVKPSPublicSoap(){}

    public NCVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NCVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NCVExtendedSoapSerializationEnvelope envelope= new NCVExtendedSoapSerializationEnvelope(NCVExtendedSoapSerializationEnvelope.VER11);
