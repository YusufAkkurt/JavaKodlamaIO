...
public class NCVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NCVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NCVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NCVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NCVDateTimeConverter dateTimeConverter = new NCVStandardDateTimeConverter();

    public NCVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NCVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NCVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NCVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NCVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NCVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
